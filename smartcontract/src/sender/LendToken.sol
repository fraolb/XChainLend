...
contract LendToken is OwnerIsCreator {
        ...
        returns (bytes32 messageId)
    {
        ...
        string memory jsonData = createMessage(msg.sender, "lend");
        ...
        emit MessageSent(messageId, _destinationChainSelector, _receiver, "Lend", _token, _amount, address(0), fees);
