...
contract DepositCollateral is OwnerIsCreator {
        ...
        returns (bytes32 messageId)
    {
        ...
        string memory jsonData = createMessage(msg.sender, "depositCollateral");
        ...
        emit MessageSent(
            messageId, _destinationChainSelector, _receiver, "depositCollateral", _token, _amount, address(0), fees
        );
